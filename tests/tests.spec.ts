...
test.describe('Test suite', () => {
  ...
  test('01 - View all "View"', async ({ page }) => {
  ...
  test('02 - Create room', async ({ page }) => {
   ...
   const numberRandom = faker.number.int({min: 1, max: 100})
   

   await page.locator('div').filter({ hasText: /^Number$/ }).getByRole('spinbutton').fill(numberRandom.toString());


   await page.locator('div').filter({ hasText: /^Floor$/ }).getByRole('spinbutton').fill(numberRandom.toString());
    ...
    await page.locator('div').filter({ hasText: /^Price$/ }).getByRole('spinbutton').fill('10000');
    ...
    await expect(page.getByText(`Floor ${numberRandom}, Room`)).toBeVisible();
    

  });

  test('03 - Create room without filling anything, should recive errors', async ({ page }) => {
 ...
 test('04 - Edit room', async ({ page }) => {
   ...
   await page.locator('div').filter({ hasText: /^Number$/ }).getByRole('spinbutton').fill(randomNumber.toString());

   await page.locator('div').filter({ hasText: /^Floor$/ }).getByRole('spinbutton').fill(randomNumber.toString());

   await page.locator('div').filter({ hasText: /^Price$/ }).getByRole('spinbutton').fill(randomNumber.toString());

   await page.locator('#app > div > div.actions > a.btn.blue').click();
   await expect(page.getByText(`Floor ${randomNumber}, Room`)).toBeVisible();
   await expect(page.getByText(`Price: ${randomNumber}kr`)).toBeVisible();

  });

 test('05 - Delete room', async ({ page }) => {
 ...
 test('07 - Create new client and check if Clients "Number count" is changed ', async ({ page }) => {
 ...
 test('08 - Make a reservation using same input as the existing one, should recive error', async ({ page }) => {
 ...
 test('09 - Edit a room and put price as 0, should recive error ', async ({ page }) => {
   ...
   await page.locator('div').filter({ hasText: /^Price$/ }).getByRole('spinbutton').fill('0');
 ...
 test('10 - Make a new reservation without filling in start & end date, should recive errors', async ({ page }) => {
 ...
 test('11 - Create a Bill ', async ({ page }) => {
 ...
 test('12 - Create a Bill wihtout any inputs, should recive errors ', async ({ page }) => {
